...
fn parse_instruction(line: &str, label_list: &[(String, u16)]) -> Vec<u8> {
    ...
    match inst {
        "LoadImm" => vec![t(0) | d(op.op()) | s(6), op.op()],
        "Load" => vec![t(3) | d(op.op()) | s(op.op())],
        "AddImm" => vec![t(0) | d(0) | s(4), op.op()],
        "Add" => vec![t(2) | d(0) | s(op.op())],
        "AddImmCarry" => vec![t(0) | d(1) | s(4), op.op()],
        "AddCarry" => vec![t(2) | d(1) | s(op.op())],
        "SubImm" => vec![t(0) | d(2) | s(4), op.op()],
        "Sub" => vec![t(2) | d(2) | s(op.op())],
        "SubImmBorrow" => vec![t(0) | d(3) | s(4), op.op()],
        "SubBorrow" => vec![t(2) | d(3) | s(op.op())],
        "AndImm" => vec![t(0) | d(4) | s(4), op.op()],
        "And" => vec![t(2) | d(4) | s(op.op())],
        "OrImm" => vec![t(0) | d(6) | s(4), op.op()],
        "Or" => vec![t(2) | d(6) | s(op.op())],
        "XorImm" => vec![t(0) | d(5) | s(4), op.op()],
        "Xor" => vec![t(2) | d(5) | s(op.op())],
        "CompImm" => vec![t(0) | d(7) | s(4), op.op()],
        "Comp" => vec![t(2) | d(7) | s(op.op())],
        "Jump" => vec![t(1) | d(0) | s(4), op.lsp(), op.msp()],
        "JumpIf" => vec![t(1) | d(op.op() + 4) | s(0), op.lsp(), op.msp()],
        "JumpIfNot" => vec![t(1) | d(op.op()) | s(0), op.lsp(), op.msp()],
        "Call" => vec![t(1) | d(0) | s(6), op.lsp(), op.msp()],
        "CallIf" => vec![t(1) | d(op.op() + 4) | s(2), op.lsp(), op.msp()],
        "CallIfNot" => vec![t(1) | d(op.op()) | s(2), op.lsp(), op.msp()],
        "Return" => vec![t(0) | d(0) | s(7)],
        "ReturnIf" => vec![t(0) | d(op.op() + 4) | s(3)],
        "ReturnIfNot" => vec![t(0) | d(op.op()) | s(3)],
        "ShiftRight" => vec![t(0) | d(1) | s(2)],
        "ShiftLeft" => vec![t(0) | d(0) | s(2)],
        "Nop" => vec![t(3) | d(0) | s(0)],
        "Halt" => vec![0],
        "Input" => vec![t(1) | d(0) | s(1)],
        "Pop" => vec![t(0) | d(6) | s(0)],
        "Push" => vec![t(0) | d(7) | s(0)],
        "EnableIntr" => vec![t(0) | d(5) | s(0)],
        "DisableInts" => vec![t(0) | d(4) | s(0)],
        "SelectAlpha" => vec![t(0) | d(3) | s(0)],
        "Adr" => vec![0o121],
        "Status" => vec![0o123],
        "Data" => vec![0o125],
        "Write" => vec![0o127],
